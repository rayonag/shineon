...
const App = () => {
    ...
    return (
        <>
            <button onClick={getresponse}>button here</button>
        </>
    );
        ...
        <div style={{ width: "100%", display: "flex", flexDirection: "column", alignItems: "center" }}>
            ...
            <div className="w-[60%] flex flex-col">
                <div className="flex flex-col">
                    <input className="bg-gray-600" placeholder="Subject, Chapter, Unit" />
                    <span>Title</span>
                </div>
                <div className="flex flex-col">
                    <input className="bg-gray-600" placeholder="What is this set?" />
                    <span>Description</span>
                </div>
                <div className="flex flex-col">
                    <button className="border border-neutral-200 hover:bg-slate-100 hover:text-black">Scan</button>
                </div>
                <div style={{ width: "100%" }}>
                    <form onSubmit={addRecord}>
                        ...
                        <div style={{ flexBasis: "100px", textAlign: "center" }}>
                            <button type="submit">Add this set</button>
                        </div>
                    </form>
                </div>
